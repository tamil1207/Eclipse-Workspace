...
public class Alert2 {
	...
	public static void main(String[] args) {
		...
		name1.click();
		WebElement name2 = driver.findElement(By.xpath("//button[@class='btn btn-danger']"));
		name2.click();
		WebElement name4 = driver.findElement(By.xpath("//button[@onclick='alertbox()']"));
		name4.click();
		Alert alertob= driver.switchTo().alert();
		String names= alertob.getText();
